...
export const DEMO_TASKS: Task[] = [
  ...
  { id: 'tk3',  title: 'Finalise colour palette',                                                                                   projectId: 'p1', status: 'to-test',    priority: 'medium', assigneeIds: ['m7'],       dueDate: dateStr(12), createdAt: msAgo(18), updatedAt: msAgo(2) },
  { id: 'tk4',  title: 'Brand guidelines document',                                                                                  projectId: 'p1', status: 'todo',       priority: 'medium',                           createdAt: msAgo(15), updatedAt: msAgo(15) },
