...
export default function DocumentOverview({ documents, limit = 5 }: DocumentOverviewProps) {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-[24px] overflow-hidden flex flex-col h-full">
      <CardHeader title="Documents" iconName="description" >
        <ButtonIcon iconName="arrow_outward" clickHandler={() => { }} aria-label="Go to documents page" />
      </CardHeader>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                  ...
                  {doc.author && (
                    <AuthorBadge type={doc.author.type} name={doc.author.name} />
                  )}
                </div>
              </div>
