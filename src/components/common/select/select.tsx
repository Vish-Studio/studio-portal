    ...
    return (
      <div ref={rootRef} className={cn('select relative', wrapperClassName)}>
        ...
        <button
          ...
          className={cn(
            'select-trigger flex w-full items-center justify-between gap-3 border bg-gray-50 px-4 py-3 text-left text-base text-gray-900 rounded-xl sm:text-sm',
            ...
            {options.map(option => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    'select-option flex w-full items-center gap-2 rounded-xl px-3 py-2.5 text-left text-sm transition-colors',
                    option.disabled
