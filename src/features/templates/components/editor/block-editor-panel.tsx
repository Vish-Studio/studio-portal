...
import { Plus, Trash2 } from '@/src/shared/components/material-icon/material-lucide-icons';
import type { TemplateBlock, ServiceRow, PaymentRow, PartyInfo } from '../../templateBlocks';
