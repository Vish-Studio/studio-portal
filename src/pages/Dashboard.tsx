        ...
        <div className="flex-1 flex flex-col gap-8">
          ...
          {/* Top 3 Cards Row */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-[#F6F7F9] shadow-sm rounded-[32px] p-6 flex flex-col items-start gap-4">
                ...
                <div className="mt-2">
                   <span className="text-[42px] font-bold tracking-tight text-[#121316] leading-none">24</span>
                </div>
              ...
              <div className="bg-[#E0FE8A] shadow-sm rounded-[32px] p-6 flex flex-col items-start gap-4">
                <div className="flex w-full justify-between items-center">
                ...
                <div className="mt-2">
                   <span className="text-[42px] font-bold tracking-tight text-[#121316] leading-none">12</span>
                </div>
                <div className="flex items-center gap-2 mt-auto">
              ...
              <div className="bg-[#121316] shadow-sm rounded-[32px] p-6 flex flex-col items-start gap-4">
                <div className="flex w-full justify-between items-center">
