...
import { ExternalLink, FileText, Presentation, FileCheck2, FileHeart, FolderOpen, PenTool } from 'lucide-react';
import UserLayout from '@/src/components/user/user-layout/user-layout';
import { useDocumentsStore } from '@/src/store/documents';
import type { StudioDocument } from '@/src/store/documents';
            ...
            <div className="bg-white p-8 rounded-[28px] max-w-md w-full shadow-2xl">
              ...
              <form onSubmit={handleSign} className="space-y-4">
                ...
                <div className="flex gap-3 pt-4">
                  <button
                    type="button"
                    onClick={() => { setSigningDoc(null); setSignatureName(''); }}
        ...
        {myDocuments.length === 0 ? (
          <div className="bg-white border border-gray-200 p-12 rounded-[28px] text-center shadow-sm">
            ...
            <p className="text-gray-500 mt-2 font-medium text-sm">
              When documents are shared with you they will appear here.
            </p>
          </div>
        ) : (
